...
export const Card = ({ result }) => {
  return (
    <div className="cursor-pointer sm:p-1 sm:hover:shadow-slate-400 sm:shadow-sm rounded-lg sm:border sm:border-slate-400 sm:m-2 transition-shadow duration-200 group">
